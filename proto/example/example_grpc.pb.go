...
func (c *exampleClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	out := new(CommonResponse)
	err := c.cc.Invoke(ctx, "/example.Example/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *exampleClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	out := new(CommonResponse)
...
func (UnimplementedExampleServer) Add(context.Context, *AddRequest) (*CommonResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedExampleServer) Get(context.Context, *GetRequest) (*CommonResponse, error) {
...
func _Example_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.Example/Add",
	}
